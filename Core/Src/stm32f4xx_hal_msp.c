...
void HAL_MspInit(void)
{
  ...
  HAL_NVIC_SetPriority(EXTI15_10_IRQn, 20, 0);  // set priority per interrupt pulsanti da 10 a 15 contiene sdoppaita navigatore
...
void EXTI15_10_IRQHandler(void) {
    HAL_GPIO_EXTI_IRQHandler(SDOPPIATA_NAVIGATORE_Pin);
}
/**
