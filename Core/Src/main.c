...
#include "../../BSP/STM32469I-Discovery/stm32469i_discovery_qspi.h"
#include "string.h"
...
uint16_t sec_osc=0; // secondi contati da oscillatore
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : SDOPPIATA_PILOTA_Pin */
  GPIO_InitStruct.Pin = SDOPPIATA_PILOTA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(SDOPPIATA_PILOTA_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : SDOPPIATA_NAVIGATORE_Pin */
  GPIO_InitStruct.Pin = SDOPPIATA_NAVIGATORE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(SDOPPIATA_NAVIGATORE_GPIO_Port, &GPIO_InitStruct);
...
// Callback chiamato dall'ISR quando si verifica l'interrupt
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin) {
    if (GPIO_Pin == SDOPPIATA_NAVIGATORE_Pin) {
        // Il codice da eseguire quando viene rilevata una chiusura del pin PB14 al ground
    	  PRONO_PRINT("\n CACCA cazzo ");
    }
}
